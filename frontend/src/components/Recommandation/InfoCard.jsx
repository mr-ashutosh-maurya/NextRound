...
const InfoCard = () => {
  ...
  return (
    <div className="rounded-2xl max-w-7xl mx-auto px-10 pt-10 bg-gradient-to-r from-white to-red-100 border border-red-200 flex items-center justify-between shadow-sm">
      {/* left side */}
