...
const JobCards = ({ job }) => {
  ...
  return (
    <div
      ...
      className="group p-6 rounded-2xl shadow-md bg-white border hover:shadow-2xl hover:border-blue-300 transition-all cursor-pointer flex flex-col justify-between"
    >
      {/* Company Info */}
